...
# flag to be Tested
flags = {
    'passMETTriggers2016' : '( (passHBHENoiseFilter == 1) &&  (passHBHENoiseIsoFilter == 1) && (passglobalSuperTightHalo2016Filter == 1) && (passgoodVertices == 1) && (passEcalDeadCellTriggerPrimitiveFilter == 1) && (passBadPFMuonFilter == 1) )'
    
    }
baseOutDir = 'results/METTriggers/'
...
samplesDef = {
    'data'   : tnpSamples.samples2016['data_Run2016B'].clone(),
    'mcNom'  : tnpSamples.samples2016['DY_LO'].clone(),
    'mcAlt'  : tnpSamples.samples2016['DY_NLO'].clone(),
    'tagSel' : None, #tnpSamples.samples2016['DY_NLO'].clone(),
}
## can add data sample easily
samplesDef['data'].add_sample( tnpSamples.samples2016['data_Run2016C'] )
samplesDef['data'].add_sample( tnpSamples.samples2016['data_Run2016D'] )
samplesDef['data'].add_sample( tnpSamples.samples2016['data_Run2016E'] )
samplesDef['data'].add_sample( tnpSamples.samples2016['data_Run2016F'] )
samplesDef['data'].add_sample( tnpSamples.samples2016['data_Run2016G'] )
samplesDef['data'].add_sample( tnpSamples.samples2016['data_Run2016H'] )
